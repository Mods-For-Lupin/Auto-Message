...
public class ClientMessageService {
  ...
  public static void load() {
    ...
    File configFile = new File(
        configDirPath + File.separator + Constants.MOD_ID + "-client" + ".json");
    ...
    if (!configFile.isFile()) {
      ...
      File configMessagesFile = new File(
          configDirPath + File.separator + "messages" + File.separator + "client_messages.json");
      MessageServiceUtil.copyResourceToFile("/assets/automessage/client_messages.json",
          configMessagesFile);
    ...
    if (configFile.isFile()) {
      ...
      if (instance.message_json_files == null || instance.message_json_files.isEmpty()) {
        Constants.LOG.info("[CLIENT] No message files listed in configuration: {}",
            configFile.getName());
...
//            }
    ...
    long time = end - start;
    Constants.LOG.info("[CLIENT] MessageService loaded on client in {}ns or {}ms or {}s", time,
